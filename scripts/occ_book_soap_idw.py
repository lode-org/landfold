#!/usr/bin/env python3
"""Compact-support kNN IDW of E-E_GM on the SOAP mean_r16a8_z plane.

Re-paints the RBF/IMQ SOAP map with the same IDW kernel as
occ_book_idw_fill.py. If the GM teal well and ico blue well survive,
the points themselves are low E; if they vanish, RBF invented them.
"""
...
XY = BOOK / "cand-soap" / "mean_r16a8_z.xy"
ENERGY = BOOK / "lj38.energy"
FIG = OUT / "elja_occ_lj38_soap_idw.png"
CAND = BOOK / "cand-soap"
KS = (1, 4, 8)
GM_E = -173.928427
ICO_E = -173.252378
...
def main() -> None:
    ...
    fig.suptitle(
        r"SOAP mean $r_{16}a_8$ $z$   compact-support kNN IDW of $E-E_{\mathrm{GM}}$",
        fontsize=12,
    )
