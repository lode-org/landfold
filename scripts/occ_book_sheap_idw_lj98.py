#!/usr/bin/env python3
"""Compact-support kNN IDW of E-E_GM on the LJ98 SHEAP dual-funnel plane.
...
FIG = OUT / "elja_occ_lj98_sheap_idw.png"
KS = (1, 4, 8)
GM_WELL = 0.55
MOTIF_WELL = 1.50
VMAX = 5.0
...
def main() -> None:
    ...
    for ax, k in zip(axes, KS):
        ...
        print(
            f"k={k} F(GM)={fgm:.4f} F(2nd)={f2:.4f} NN_E(GM)={nn_e:.4f} "
    ...
    fig.suptitle(
        r"LJ98 SHEAP dual-funnel   compact-support kNN IDW of $E-E_{\mathrm{GM}}$",
        fontsize=12,
    )
