#!/usr/bin/env python3
"""Two-panel defeat visual: leftover occupancy invert vs SOAP energy.
...
Right: SOAP mean_r16a8_z plane, compact-support IDW of E-E_GM.
F(GM)=0, F(ico)=0.676.
...
FIG = OUT / "elja_occ_lj38_occ_vs_soap.png"
SRC_DIRS = (
...
def main() -> None:
    ...
    for name, xy in (("occ", xy_occ), ("soap", xy_soap)):
    ...
    axes[1].set_title(f_title(r"SOAP energy", fgm_s, fico_s, digits=3), fontsize=11)
